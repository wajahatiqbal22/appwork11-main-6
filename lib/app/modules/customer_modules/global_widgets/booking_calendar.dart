...
import 'package:home_services/app/modules/customer_modules/book_e_service/controllers/time_slot_controller.dart';
...
class BookingSlotController extends GetxController {
  ...
  void _generateBookingSlots() {
    ...
    allBookingSlots.addAll(List.generate(_maxServiceFitInADay(),
...
class BookingCalendarMain extends StatefulWidget {
  ...
  final Future<dynamic> Function({ DateTime newBooking})? uploadBooking;
...
class _BookingCalendarMainState extends State<BookingCalendarMain> {
  ...
  void selectNewDateRange() {
    TimeSlotController controller = Get.find();
      ...
      child: Column(
        children: [
            ...
            builder: (context, snapshot) {
              ...
              return Obx(() => Expanded(
                    child: GridView.builder(
                      ...
                      itemCount: controller.allBookingSlots.value.length,
                      itemBuilder: (context, index) => Obx(() => BookingSlot(
                            isBooked: controller.isSlotBooked(index),
                            isSelected: index == controller.selectedSlot.value,
                            onTap: () => controller.selectSlot(index),
                            child: Center(
                              child: Text(
                                widget.formatDateTime!=null?
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        childAspectRatio:
                            widget.bookingGridChildAspectRatio ?? 1.7,
                      ),
                    ),
                  ));
            },
          ...
          Obx(() => CommonButton(
                ...
                isDisabled: controller.selectedSlot.value == -1,
