...
class NotificationItemWidget extends StatelessWidget {
  NotificationItemWidget({Key? key, required this.notification, required this.onDismissed, required this.onTap}) : super(key: key);
              ...
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      DateFormat('d, MMMM y | HH:mm a', Get.locale.toString()).format(this.notification.createdAt!),
