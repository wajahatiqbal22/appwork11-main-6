...
import '../widgets/category_small_grid_item_widget.dart';
                  ...
                  child: controller.categories.isEmpty
                      ...
                      : StaggeredGridView.countBuilder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return CategorySmallGridItemWidget(category: controller.categories.elementAt(index), heroTag: "heroTag");
                          },
                          staggeredTileBuilder: (int index) =>  StaggeredTile.fit(Get.mediaQuery.orientation == Orientation.portrait ? 2 : 4),
