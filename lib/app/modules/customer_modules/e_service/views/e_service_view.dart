...
import 'package:home_services/app/modules/customer_modules/e_provider/widgets/availability_hour_item_widget.dart';
import 'package:home_services/app/modules/customer_modules/e_provider/widgets/e_provider_til_widget.dart';
                  ...
                  SliverAppBar(
                    ...
                    actions: [
                      ...
                      new IconButton(
                        ...
                        onPressed: () {
                          var postUrl= DynamicLinkService.createFirstPostLink(_eService, "service_list_item",true,_eService.name.toString());
                          postUrl.then((value) {
                            print("postUrl:"+value.toString());
                            print(_eService.name);
                            Share.share('check out this ${_eService.name} service $value');
                          });
                  ...
                  SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        ...
                        EServiceTilWidget(
                          title: Text("Service Description".tr,
      ...
      child: Row(
        children: [
          Expanded(
            child: Column(
              children: [
                Text("Duration".tr, style: Get.textTheme.bodyText2),
    ...
    if (_eService.eProvider?.hasData ?? false) {
      return GestureDetector(
        ...
        child: EServiceTilWidget(
          ...
          content: Column(
            children: [
              EProviderItemWidget(provider: _eService.eProvider!),
              buildAvailabilityHours(_eService.eProvider!)
            ],
            mainAxisSize: MainAxisSize.min,
          ),
          actions: [
        ...
        children: [
          ...
          Expanded(
            child: BlockButtonWidget(
                ...
                color: Get.theme.accentColor,
                onPressed: () {
                  print(_eService.priceUnit);
                  if(_eService.priceUnit == 'fixed')
                    {
                      if( controller.getCheckedOptions().isNotEmpty)
                      {
