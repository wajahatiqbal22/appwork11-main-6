...
class ConfirmationView extends GetView<CheckoutController> {
  ...
  Widget build(BuildContext context) {
    final arguments = Get.arguments is Map ? Get.arguments : {};
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 40),
            Text(
              arguments['short_message'] ?? "Complete!".tr,
            ...
            Opacity(
              ...
              child: Text(
                arguments['long_message'] ??
                    "Your booking has been successfully submitted, you will redirected to the payment page now"
                        .tr,
                textAlign: TextAlign.center,
  ...
  Widget buildBlockButtonWidget() {
    return Container(
      ...
      child: BlockButtonWidget(
          ...
          onPressed: () {
            Get.toNamed(Routes.CHECKOUT, arguments: controller.booking.value);
