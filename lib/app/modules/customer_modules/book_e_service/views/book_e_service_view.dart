...
class BookEServiceView extends GetView<BookEServiceController> {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
            ...
            children: [
    Expanded(
    child: Text("When would you like us to serve you?".tr,
    ...
    elevation: 0,
    onPressed: () {
    controller.showTimeSlotPicker();
    },
    shape: StadiumBorder(),
    color: Get.theme.colorScheme.secondary.withOpacity(0.2),
    child: Text("Choose timeslot".tr,
    style: Get.textTheme.subtitle1),
            ...
            Obx(() {
              return AnimatedOpacity(
                ...
                child: Obx(() {
                    if (controller.scheduled.isFalse) {
                      return SizedBox();
                    }
                  return Column(
                    children: [
                      ...
                      Text('${DateFormat('HH:mm a', Get.locale.toString()).format(controller.booking.value.bookingAt!)}', style: Get.textTheme.headline3),
                      SizedBox(height: 20)
                    ],
                  );
                }),
