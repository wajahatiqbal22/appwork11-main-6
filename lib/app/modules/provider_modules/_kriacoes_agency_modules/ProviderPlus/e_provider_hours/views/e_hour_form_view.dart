...
class EHoursFormView extends GetView<EHoursFormController> {
  List<String> daysList = ["Sun", "Mon", "Tues", "Wed", "Thurs", "Fri", "Sat"];
                  ...
                  TextFieldWidget(
                    onSaved: (input) {
                      ...
                      controller.eHours.value.endAt =
                          controller.eHours.value.endAt;
*/
                      for (int i = 0; i < controller.eHoursList.length; i++) {
/*                          controller.eHoursList[i].provider =
                              controller.eProviders.first.id;*/
                        controller.eHoursList[i].data = input;
                      }
                    },
                    labelText:
                      ...
                      children: [
                        ...
                        Obx(() {
                          return ListView.separated(
                            ...
                            itemCount: controller.eHoursList.length,
                                ...
                                children: [
                                  Container(
                                    child: FlutterCustomSwitch(
                                      ...
                                      toggleSize: 20.0,
                                      value: controller
                                          .eHoursList[index].isSelected!,
                                      borderRadius: 20.0,
                                      padding: 6.0,
                                      activeText: daysList[index],
                                      inactiveText: daysList[index],
                                      activeColor: Get.theme.accentColor,
                                      showOnOff: true,
                                      onToggle: (val) {
                                        controller
                                            .eHoursList[index].isSelected = val;
                                        controller.eHoursList.refresh();
                                      },
                                    ),
                                  ),
                                  controller.eHoursList[index].isSelected ==
                                          true
                                      ? MaterialButton(
                                          onPressed: () {
                                            controller.showStartTimePicker(
                                  ...
                                  controller.eHoursList[index].isSelected ==
                                      ...
                                      ? MaterialButton(
                                          ...
                                          color:
                                              Get.theme.colorScheme.secondary,
                                          child: Text(
                                              controller.eHoursList[index].endAt ==
                                                      null
                                                  ? "Select".tr
                                                  : formatTimeOfDay(TimeOfDay(
                                                      hour: int.parse(controller
...
controller.eHours.value.day == "sunday"?   Row(
mainAxisAlignment: MainAxisAlignment.spaceBetween,
children: [
MaterialButton(
onPressed: () {
controller.showEndTimePicker(context);
},
shape: StadiumBorder(),
color: Get.theme.colorScheme.secondary,
child: Text(
