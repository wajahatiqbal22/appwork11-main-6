...
class PLoginView extends GetView<PAuthController> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      Get.toNamed(Routes.PFORGOT_PASSWORD);
                    },
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: TextButton(
                              onPressed: () {
                                Get.offAllNamed(Routes.PREGISTER);
                              },
                              child: Text(
