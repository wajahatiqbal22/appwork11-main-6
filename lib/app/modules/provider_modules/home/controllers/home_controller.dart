...
class PHomeController extends GetxController {
  ...
  PHomeController() {
    _statisticRepository = new StatisticRepository(Get.find<ProviderApiClient>());
    _bookingsRepository = new BookingRepository(Get.find<ProviderApiClient>());
  }
  ...
  Future refreshHome({bool showMessage = false, String? statusId}) async {
    ...
    Get.find<PRootController>().getEProviders();
    changeTab(statusId);
    if (showMessage) {
