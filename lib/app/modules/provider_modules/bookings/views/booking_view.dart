...
class PBookingView extends GetView<PBookingController> {
  @override
                    ...
                    BookingTilWidget(
                      ...
                      content: Column(
                        children: [
                          ...
                          Column(
                            children: List.generate(
                                controller.booking.value.taxes!.length, (index) {
                          ...
                          Obx(() {
                            return BookingRowWidget(
                              ...
                              child: Align(
                                alignment: Alignment.centerRight,
                                child: Ui.getPrice(
                                    controller.booking.value.getTaxesValue(),
                                    style: Get.textTheme.subtitle2!),
                              ),
                              hasDivider: false,
                            );
                                  ...
                                  child: Wrap(
                                    children: [
                                      ...
                                      Ui.getPrice(
                                          ...
                                          style: Get.textTheme.bodyText1!,
                                          unit: controller.booking.value.coupon!
                                                      .discountType ==
                                                  'percent'
                                              ? "%"
                                              : null),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                      DateFormat("hh:mm a").format(_booking.value.bookingAt!).toString(),
//                      DateFormat('HH:mm').format(_booking.value.bookingAt!),
                      maxLines: 1,
                      style: Get.textTheme.bodyText2!.merge(
