...
class POptionsFormView extends GetView<POptionsFormController> {
  @override
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: new IconButton(
            ...
            onPressed: () => Get.offAndToNamed(Routes.PE_SERVICE, arguments: {'eService': controller.eService.value, 'heroTag': 'option_form_back'}),
          ),
          actions: [
            new IconButton(
        ...
        bottomNavigationBar: Container(
          ...
          child: Row(
            children: [
              ...
              if (controller.option.value!=null) SizedBox(width: 10),
              if (controller.option.value!=null)
                MaterialButton(
                  onPressed: () {
              ...
              children: [
                ...
                Obx(() {
                  return ImageFieldWidget(
                    ...
                    initialImage: controller.option.value!=null? controller.option.value.image:Media(),
                ...
                TextFieldWidget(
                  ...
                  initialValue: controller.option.value!=null?controller.option.value.name:"",
                ...
                TextFieldWidget(
                  ...
                  initialValue:  controller.option.value!=null?controller.option.value.description:"",
                ...
                TextFieldWidget(
                  ...
                  initialValue:  controller.option.value!=null?controller.option.value.price?.toString():"",
                  hintText: "23.00".tr,
                  labelText: "Price".tr,
  ...
  Widget buildOptionGroup(String? _group) {
    return Padding(
      ...
      child: Container(
        ...
        child: Text(_group.toString() , style: Get.textTheme.bodyText2),
