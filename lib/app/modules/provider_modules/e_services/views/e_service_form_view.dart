...
class PEServiceFormView extends GetView<PEServiceFormController> {
  @override
          ...
          leading: new IconButton(
            ...
            onPressed: () async {
              controller.isCreateForm()
                  ? await Get.offAndToNamed(Routes.PE_SERVICES)
                  : await Get.offAndToNamed(Routes.PE_SERVICE, arguments: {'eService': controller.eService.value, 'heroTag': 'service_form_back'});
            },
          ),
          elevation: 0,
          actions: [
            ...
            child: Column(
              ...
              children: [
                ...
                TextFieldWidget(
                  ...
                  hintText: "Cleaner , Day labor ,handyman etc ..".tr,
                  labelText: "Name".tr,
                ),
                TextFieldWidget(
                  ...
                  hintText: "Description for service".tr,
