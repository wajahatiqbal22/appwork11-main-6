...
class PEServiceView extends GetView<PEServiceController> {
  @override
      ...
      if (!_eService.hasData) {
        ...
        return Scaffold(
          floatingActionButton: new FloatingActionButton(
            ...
            onPressed: () => {
              Get.offAndToNamed(Routes.PE_SERVICE_FORM, arguments: {'eService': _eService})
            },
                            ...
                            content: Container(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (_, index) {
                                    ...
                                    return InkWell(
                                      onTap: () {
                                        Get.toNamed(Routes.PGALLERY, arguments: {'media': _eService.images, 'current': _media, 'heroTag': 'e_services_galleries'});
                                      },
                                      child: Container(
                                        width: 100,
                                        height: 100,
