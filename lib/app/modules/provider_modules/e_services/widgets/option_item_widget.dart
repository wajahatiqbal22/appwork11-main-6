...
class OptionItemWidget extends GetWidget<PEServiceController> {
  OptionItemWidget({
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return GestureDetector(
        onTap: () {
          Get.offAndToNamed(Routes.POPTIONS_FORM, arguments: {'eService': new EService(id: _option.eServiceId), 'option': _option});
        },
        child: Container(
