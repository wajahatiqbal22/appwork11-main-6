...
class MessageItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Get.toNamed(Routes.PCHAT, arguments: this.message);
      },
      child: Dismissible(
                  ...
                  children: <Widget>[
                    Row(
                      children: [
                        ...
                        Text(
                          DateFormat('HH:mm a', Get.locale.toString()).format(DateTime.fromMillisecondsSinceEpoch(this.message.lastMessageTime!)),
                          overflow: TextOverflow.fade,
                          softWrap: false,
