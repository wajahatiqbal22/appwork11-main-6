...
class AuthService extends GetxService {
  ...
  late UserRepository _customerUsersRepo;
  late UserRepository _providerUsersRepo;

  AuthService() {
    _customerUsersRepo = CustomerUserRepository();
    _providerUsersRepo = ProviderUserRepository();
    _box = new GetStorage();
  }
  ...
  Future removeCurrentUser() async {
    user.value = new User();
    await _customerUsersRepo.signOut();
    await _providerUsersRepo.signOut();
