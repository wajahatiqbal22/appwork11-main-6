...
class Ui {
  ...
  static GetSnackBar notificationSnackBar({String title = 'Notification',required String message, OnTap? onTap, Widget? mainButton}) {
    Get.log("[$title] $message", isError: false);
    return GetSnackBar(
      onTap: onTap,
  ...
  static Widget getPrice(double? myPrice, {required TextStyle style, String zeroPlaceholder = '-', String? unit}) {
  ...
  static TextStyle getPriceStyle(TextStyle style) {
    if (style == null) {
      return Get.textTheme.subtitle2!.merge(
        TextStyle(fontWeight: FontWeight.w600, fontSize: Get.textTheme.subtitle2!.fontSize! - 4),
      );
    } else {
      return style.merge(TextStyle(fontWeight: FontWeight.w400, fontSize: style.fontSize! - 1));
    }
  }
